...
class UMAPVisualizer:
    ...
    def analyze_multiple_datasets(self,
                                  ...
                                  synthetic_configs: List[DatasetConfig]) -> Dict:
        """
...
Examples:
  ...
  python 02_umap_clustering.py \\
    ...
    parser.add_argument('--cluster-epsilon', type=float, default=0.1,
    ...
    results = visualizer.analyze_multiple_datasets(ref_config, synth_configs)
